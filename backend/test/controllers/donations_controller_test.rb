...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { cidade: @donation.cidade, data: @donation.data, doador: @donation.doador, estado: @donation.estado, tipo: @donation.tipo } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { cidade: @donation.cidade, data: @donation.data, doador: @donation.doador, estado: @donation.estado, tipo: @donation.tipo } }
